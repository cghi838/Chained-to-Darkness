...
public class InteractableObject : MonoBehaviour
{
    ...
    [SerializeField] private bool disableIfAlreadyUsed = false;
    ...
    [SerializeField] private bool environmentalTargetState = true;
    ...
    private void Start()
    {
        if (ObjectStateManager.Instance != null && !string.IsNullOrEmpty(objectId))
        {
            ...
            if (hasBeenUsed && disableIfAlreadyUsed)
    ...
    private void TriggerEnvironment()
    {
        ...
        environmentalTarget.SetActive(environmentalTargetState);
    }
}